    ...
    <DialogContent class="sm:max-w-md">
      ...
      <div class="grid gap-4 py-4">
        <div class="grid grid-cols-4 items-center gap-4">
          ...
          <Input id="title" placeholder="Введите заголовок" v-model="news.title" class="col-span-3" />
        </div>
        <div class="grid grid-cols-4 items-center gap-4">
        ...
        <div class="grid grid-cols-4 items-center gap-4">
          ...
          <Textarea id="content" placeholder="Опишите ваше объявление"  class="col-span-3" v-model="news.textContent"/>
        </div>
      </div>
      <DialogFooter class="">
